...
{
	/// <summary>
	/// Unit tests for the ProgramQuestionDuplicator class.
	/// </summary>
	public class ProgramQuestionDuplicator_UnitTests
	{
		/// <summary>
		...
		public void DuplicateQuestionAsync_DuplicatesTests()
		{
			...
			var duplicator = new ProgramQuestionDuplicator(database.Context, question);
			var result = (ProgramQuestion)duplicator.DuplicateQuestion();
