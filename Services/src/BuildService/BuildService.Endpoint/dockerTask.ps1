...
.PARAMETER Clean
Removes the image buildservice.endpoint and kills all containers based on that image.
.PARAMETER Build
...
Build a Docker image named buildservice.endpoint
#>
...
$imageName="buildservice.endpoint"
