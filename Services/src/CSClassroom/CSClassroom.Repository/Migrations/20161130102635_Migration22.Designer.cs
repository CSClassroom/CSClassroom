...
namespace CSC.CSClassroom.Repository.Migrations
{
	...
	[Migration("20161130102635_Migration22")]
	partial class Migration22
	{
		protected override void BuildTargetModel(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.Assignment", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.AssignmentDueDate", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.AssignmentQuestion", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.ClassroomGradebook", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.PrerequisiteQuestion", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.SectionGradebook", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
					...
					b.HasIndex("ClassroomGradebookId");
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.AssignmentDueDate", b =>
				{
					b.HasOne("CSC.CSClassroom.Model.Exercises.Assignment", "Assignment")
						.WithMany("DueDates")
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.AssignmentQuestion", b =>
				{
					...
					b.HasOne("CSC.CSClassroom.Model.Exercises.Question", "Question")
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.PrerequisiteQuestion", b =>
				{
					b.HasOne("CSC.CSClassroom.Model.Exercises.Question", "FirstQuestion")
						.WithMany("SubsequentQuestions")
						.HasForeignKey("FirstQuestionId")
						.OnDelete(DeleteBehavior.Cascade);

					b.HasOne("CSC.CSClassroom.Model.Exercises.Question", "SecondQuestion")
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.SectionGradebook", b =>
				{
					b.HasOne("CSC.CSClassroom.Model.Exercises.ClassroomGradebook", "ClassroomGradebook")
			...
			modelBuilder.Entity("CSC.CSClassroom.Model.Exercises.UserQuestionSubmission", b =>
				{
					b.HasOne("CSC.CSClassroom.Model.Exercises.UserQuestionData", "UserQuestionData")
