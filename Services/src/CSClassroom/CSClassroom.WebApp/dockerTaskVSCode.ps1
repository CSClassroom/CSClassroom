...
.PARAMETER Clean
Removes the image csclassroom/csclassroom-webapp and kills all containers based on that image.
...
Build a Docker image named csclassroom/csclassroom-webapp
#>
