// Source: https://github.com/ppham27/phillypham/blob/master/public/javascripts/markdownAceEditor.js
...
var aceSettingsFormOptions = {
    title: 'Ace Editor Settings',
...
function MarkdownAceEditor(converter, idPostfix, options) {
    ...
    // auto-preview
    //buttons.makeSpacer(++spacerNum);
    buttons.makeCheckBox('autopreview', 'Show Preview ', this.aceOptions.autoPreview,
                         100, false, '0px');
    ...
    .addEventListener('change', function (event) {
        ...
        if (event.srcElement.checked) {
            panels.preview.style.display = "inherit";
...
function makeGrippie(editorDiv, editor) {
    ...
    grippie.style.width = "100%"; // window.getComputedStyle(editorDiv).getPropertyValue('width');
