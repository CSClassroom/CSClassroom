// Source: https://github.com/ppham27/phillypham/commits/master/lib/htmlSanitizer.js
...
function sanitizeHtmlCustomized(state) {
    ...
    var options = {
        ...
        allowedAttributes: {
            ...
            div: ['align', 'data-href', 'data-layout', 'data-action', 'data-show-faces', 'data-share', 'data-width', 'data-height', 'style'],
    ...
    var svg = {
        'svg': ['width', 'height', 'style', 'viewbox', 'xmlns', 'xmlns:xlink', 'version'],
